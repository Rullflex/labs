...
$net2ftp_settings["email_feedback"] = "libafer99@gmail.com";
...
$net2ftp_settings["message_browse"] = "Здесь находится ваша папка, в которую присылают свои работы отправители. Вы можете просмотреть их, выгрузить, загрузить обратно. По всем возникающим вопросам обращаться по email: libafer99@gmail.com";
