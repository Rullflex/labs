...
<?php /* ----- Email and privacy policies ----- */ ?>
										<div style="color: #9F6000; background-color: #FEEFB3;  border: 1px solid; margin-top: 10px; padding: 10px; font-size: 90%; display: none;">
...
<?php /* ----- Email and privacy policies ----- */ ?>
										<div style="color: #9F6000; background-color: #FEEFB3;  border: 1px solid; margin: 15px 0px 15px 0px; padding: 15px; font-size: 90%; display: none;">
